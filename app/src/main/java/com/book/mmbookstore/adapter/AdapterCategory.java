...
import static com.book.mmbookstore.util.Constant.CATEGORIES_PER_PAGE;
...
public class AdapterCategory extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            vItem.categoryName.setText(category.category_name);

            Glide.with(context)
                    .load(sharedPref.getApiUrl() + "/upload/genre/" + category.category_image.replace(" ", "%20"))
                    .placeholder(R.drawable.ic_thumbnail)
                    .thumbnail(0.1f)
                    .diskCacheStrategy(DiskCacheStrategy.ALL)
                    .into(vItem.categoryImage);
