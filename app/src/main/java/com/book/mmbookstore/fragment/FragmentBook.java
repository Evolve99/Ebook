...
public class FragmentBook extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //ItemOffsetDecoration itemDecoration = new ItemOffsetDecoration(getActivity(), R.dimen.gridSpaceBook);
        ...
        adapterBook = new AdapterBook(getActivity(), recyclerView, new ArrayList<>());
    ...
    private void requestListPostApi(final int page_no) {
        ...
        callbackCall = apiInterface.getBooks(page_no, Constant.BOOKS_PER_PAGE, sharedPref.getBookSort(), sharedPref.getBookOrder(), Config.REST_API_KEY);
